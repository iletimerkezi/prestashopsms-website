...
const config = {
  title: 'Ücretsiz Prestashop SMS Eklentisi - İleti Merkezi',
  tagline: 'Prestashop SMS modülü, kullanıcılarınıza daha kaliteli bir müşteri deneyimi sunmanız için tasarlanmıştır. Hemen deneyin.',
  url: 'https://prestashopsms.com',
  baseUrl: '/',
  onBrokenLinks: 'throw',
  ...
  projectName: 'prestashopsms-website', // Usually your repo name.
  ...
  themeConfig:
    ...
    ({
      ...
      navbar: {
        ...
        title: '',
        logo: {
          alt: 'Prestashop SMS Logo',
          src: 'img/prestashop-logo.png',
        },
        items: [
          // {
          //   type: 'doc',
      ...
      footer: {
        ...
        copyright: `Prestashop SMS T.C. Bilgi Teknolojileri ve İletişim Kurumu (BTK) tarafından yetkilendirilmiş işletmeci olan eMarka İletişim ve Bilgi Teknolojileri A.Ş. ye ait bir markadır.`,
      },
      prism: {
